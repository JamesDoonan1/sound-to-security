...
#  File paths for passphrase and voiceprint
...
def process_audio_and_generate_password(audio_path):
    ...
    for pwd in traditional_passwords:
        ...
        print(f" Traditional Password: {pwd} | Entropy: {entropy} | Brute-Force Time: {brute_time}")
...
def extract_voice_features():
    ...
    if os.path.exists(VOICEPRINT_FILE):
        ...
        print(f" Extracted Voice Features → {voiceprint}") 
        return {
